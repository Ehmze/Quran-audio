function createTrackItem(index,name,duration){
  ...
  document.querySelector("#pbp-"+index).appendChild(svg);

  var btnImg = document.createElementNS('http://www.w3.org/2000/svg', 'use');
  btnImg.setAttribute("class", "svg");
  btnImg.setAttribute("href", "#play");
  btnImg.setAttribute("id", "p-img-"+index);
  document.querySelector("#svg"+index).appendChild(btnImg);
